...
- (NSTask *)childTask {
    ...
    env[@"DYLD_INSERT_LIBRARIES"] = @"/Applications/Xcode-9.4.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.1.0/lib/darwin/libclang_rt.asan_osx_dynamic.dylib";
